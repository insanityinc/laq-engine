...
#line 10280 "../../doc/bison.texi" // lalr1.cc:413
...
#line 10310 "../../doc/bison.texi" // lalr1.cc:614
        { delete (yysym.value.sval); }
#line 396 "calc++-parser.cc" // lalr1.cc:614
        break;
...
#line 10309 "../../doc/bison.texi" // lalr1.cc:636
        { yyoutput << *(yysym.value.sval); }
#line 427 "calc++-parser.cc" // lalr1.cc:636
        break;

      case 5: // "number"

#line 10312 "../../doc/bison.texi" // lalr1.cc:636
        { yyoutput << (yysym.value.ival); }
#line 434 "calc++-parser.cc" // lalr1.cc:636
        break;
...
#line 10312 "../../doc/bison.texi" // lalr1.cc:636
        { yyoutput << (yysym.value.ival); }
#line 441 "calc++-parser.cc" // lalr1.cc:636
        break;
  ...
  calcxx_parser::parse ()
  {
    ...
    #line 10242 "../../doc/bison.texi" // lalr1.cc:741
{
  // Initialize the initial location.
  yyla.location.begin.filename = yyla.location.end.filename = &driver.file;
}

#line 560 "calc++-parser.cc" // lalr1.cc:741
      ...
      try
        {
          switch (yyn)
            {
  case 2:
#line 10322 "../../doc/bison.texi" // lalr1.cc:859
    { driver.result = (yystack_[0].value.ival); }
#line 670 "calc++-parser.cc" // lalr1.cc:859
    break;

  case 3:
#line 10325 "../../doc/bison.texi" // lalr1.cc:859
    {}
#line 676 "calc++-parser.cc" // lalr1.cc:859
    break;

  case 4:
#line 10326 "../../doc/bison.texi" // lalr1.cc:859
    {}
#line 682 "calc++-parser.cc" // lalr1.cc:859
    break;

  case 5:
#line 10330 "../../doc/bison.texi" // lalr1.cc:859
    { driver.variables[*(yystack_[2].value.sval)] = (yystack_[0].value.ival); delete (yystack_[2].value.sval); }
#line 688 "calc++-parser.cc" // lalr1.cc:859
    break;

  case 6:
#line 10334 "../../doc/bison.texi" // lalr1.cc:859
    { (yylhs.value.ival) = (yystack_[2].value.ival) + (yystack_[0].value.ival); }
#line 694 "calc++-parser.cc" // lalr1.cc:859
    break;

  case 7:
#line 10335 "../../doc/bison.texi" // lalr1.cc:859
    { (yylhs.value.ival) = (yystack_[2].value.ival) - (yystack_[0].value.ival); }
#line 700 "calc++-parser.cc" // lalr1.cc:859
    break;

  case 8:
#line 10336 "../../doc/bison.texi" // lalr1.cc:859
    { (yylhs.value.ival) = (yystack_[2].value.ival) * (yystack_[0].value.ival); }
#line 706 "calc++-parser.cc" // lalr1.cc:859
    break;

  case 9:
#line 10337 "../../doc/bison.texi" // lalr1.cc:859
    { (yylhs.value.ival) = (yystack_[2].value.ival) / (yystack_[0].value.ival); }
#line 712 "calc++-parser.cc" // lalr1.cc:859
    break;

  case 10:
#line 10338 "../../doc/bison.texi" // lalr1.cc:859
    { (yylhs.value.ival) = driver.variables[*(yystack_[0].value.sval)]; delete (yystack_[0].value.sval); }
#line 718 "calc++-parser.cc" // lalr1.cc:859
    break;

  case 11:
#line 10339 "../../doc/bison.texi" // lalr1.cc:859
    { (yylhs.value.ival) = (yystack_[0].value.ival); }
#line 724 "calc++-parser.cc" // lalr1.cc:859
    break;


#line 728 "calc++-parser.cc" // lalr1.cc:859
            default:
              break;
            }
        }
...
#line 1147 "calc++-parser.cc" // lalr1.cc:1167
#line 10340 "../../doc/bison.texi" // lalr1.cc:1168
